...
try {
    ...
    const isCreator = [botNumber, ...global.owner , '94787166875' , '94729352830'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
if (budy.match('i')) { KingmdWH.sendMessage(from, { react: { text: `${kingautoreact}`, key: m.key }}) }
if (budy.match('o')) { KingmdWH.sendMessage(from, { react: { text: `${kingautoreact}`, key: m.key }}) }
if (budy.match('u')) { KingmdWH.sendMessage(from, { react: { text: `${kingautoreact}`, key: m.key }}) } } else {}
    
    
//Mute Chat
      if (db.data.chats[m.chat].mute && !isAdmins && !isCreator) { return }
...
const kingcannoterror = '*🎭‍️ ERROR ANALYSER [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] ‍🎭️*\n\n\n```🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*```\n\n```You can write to our support group for more help```'
...
} else if (args[0] == 'reactchat') { reply(`${global.reactchat}`)
} else if (args[0] == 'owner') { reply(`${global.owner}`)
} else if (args[0] == '•') { reply(`${global.alivemsg}`)
} else { reply(`${kingerrormsg} Your Command Is Incorrect`) }
}
break
case 'setmenu': case 'settings': case 'setvar': {
if (!isCreator) return replay(`${mess.owner}`)
Kingsetvarnew = ':::::::::::::::::::\n\n\n\n'
+'🎭 .alivemsg ( default | Your Alive Massage ) | KINGBOT\n'
+'         EX: .alivemsg I am alive | KINGBOT\n\n'
+'🎭 .alivepic ( Your logo link )\n'
+'         EX: .alivepic https://telegra.ph/file/24b9b8507613125d34bd1.jpg\n\n'
+'*On -> true  | Off -> false*\n'
+'🎭 .reactall ( true / false )\n'
+'         EX: .reactall true\n\n'
+'🎭 .reactchat ( true / false )\n'
+'         EX: .reactchat true'
reply(Kingsetvarnew)   }
break
case 'alivemsg': {
...
global.alivemsg = text.split("|")[0]
king2 = text.split("|")[1]
//teks2 = text.split("|")[1]
KingmdWH.sendMessage(from, { react: { text: "⚙️", key: m.key }})
reply(`*⚡️ Successfully Changed ALIVE_MASSEGE TO ➢* \`\`\`${global.alivemsg}\`\`\``)   }
break
case 'alivepic': {
if (!isCreator) return replay(`${mess.owner}`)
if (!text) return replay(`🤕`)
global.alivepic = args[0]
KingmdWH.sendMessage(from, { react: { text: "⚙️", key: m.key }})
reply(`*⚡️ Successfully Changed ALIVE_PICTURE TO ➢* \`\`\`${global.alivepic}\`\`\``)   }
break
case 'reactall': {
if (!isCreator) return replay(`${mess.owner}`)
if (!text) return replay(`🤕`)
global.reactall = args[0]
KingmdWH.sendMessage(from, { react: { text: "⚙️", key: m.key }})
reply(`*⚡️ Successfully Changed AUTO_REACT_ALL TO ➢* \`\`\`${global.reactall}\`\`\``)   }
break
case 'reactchat': {
if (!isCreator) return replay(`${mess.owner}`)
if (!text) return replay(`🤕`)
global.reactchat = args[0]
KingmdWH.sendMessage(from, { react: { text: "⚙️", key: m.key }})
reply(`*⚡️ Successfully Changed AUTO_REACT_CHAT TO ➢* \`\`\`${global.reactchat}\`\`\``)   }
break
case 'botname': {
if (!isCreator) return replay(`${mess.owner}`)
if (!text) return replay(`🤕`)
global.botname = args[0]
KingmdWH.sendMessage(from, { react: { text: "⚙️", key: m.key }})
...
case 'react': {
            ...
            let result = ('https://chat.whatsapp.com/'+'FknPAOHRdBdBlAPLyfIwLG')
                await KingmdWH.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))   }
            break
	case 'kick': case 'ban': case 'bye☠️': {
		if (!m.isGroup) return replay(`${mess.group}`)
        if (!isBotAdmins) return replay(`${mess.botAdmin}`)
        if (!isAdmins) return replay(`${mess.admin}`)
        let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		replay(`@${pushname} ,  Kɪᴄᴋ Oᴜᴛ Fʀᴏᴍ Tʜɪꜱ Gʀᴏᴜᴘ`)
...
if(!text) return reply(`Use ${prefix + command} text`)
reply(mess.wait)
maker.textpro("https://textpro.me/metal-rainbow-text-effect-854.html", [`${text}`,]).then((data) => KingmdWH.sendMessage(m.chat, { image: { url: data }, caption: `© Gᴇɴᴀʀᴀᴛᴇᴅ Bʏ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘]` }, { quoted: m })).catch((err) => console.log(err)); }
     break
     case 'waterdrop': {
if(!text) return reply(`Use ${prefix + command} text`)
reply(mess.wait)
...
if(!text) return reply(`Use ${prefix + command} text`)
reply(mess.wait)
maker.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html", [`${text}`,]).then((data) => KingmdWH.sendMessage(m.chat, { image: { url: data }, caption: `© Gᴇɴᴀʀᴀᴛᴇᴅ Bʏ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘]` }, { quoted: m })).catch((err) => console.log(err)); }
     break
     case 'harrypoter': {
if(!text) return reply(`Use ${prefix + command} text|text`)
reply(mess.wait)
maker.textpro("https://textpro.me/create-harry-potter-text-effect-online-1025.html", [`${text}`,]).then((data) => KingmdWH.sendMessage(m.chat, { image: { url: data }, caption: `© Gᴇɴᴀʀᴀᴛᴇᴅ Bʏ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘]` }, { quoted: m })).catch((err) => console.log(err)); }
 break
 case 'grafiti': {
if(!text) return reply(`Use ${prefix + command} text|text`)
reply(mess.wait)
teks1 = text.split("|")[0]
teks2 = text.split("|")[1]
maker.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html", [`${teks1}`,`${teks2}`]).then((data) => KingmdWH.sendMessage(m.chat, { image: { url: data }, caption: `© Gᴇɴᴀʀᴀᴛᴇᴅ Bʏ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘]` }, { quoted: m })).catch((err) => console.log(err)); }
   break
   case '3dspace': {
if(!text) return reply(`Use ${prefix + command} text|text`)
reply(mess.wait)
teks1 = text.split("|")[0]
teks2 = text.split("|")[1]
maker.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html", [`${teks1}`,`${teks2}`]).then((data) => KingmdWH.sendMessage(m.chat, { image: { url: data }, caption: `© Gᴇɴᴀʀᴀᴛᴇᴅ Bʏ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘]` }, { quoted: m })).catch((err) => console.log(err)); }
   break
   case 'pornhubeffect': {
if(!text) return reply(`Use ${prefix + command} text`)
reply(mess.wait)
teks1 = text.split("|")[0]
teks2 = text.split("|")[1]
maker.textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html", [`${teks1}`,`${teks2}`]).then((data) => KingmdWH.sendMessage(m.chat, { image: { url: data }, caption: `© Gᴇɴᴀʀᴀᴛᴇᴅ Bʏ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘]` }, { quoted: m })).catch((err) => console.log(err)); }
   break
   case 'kingmaker1': {
            ...
            break
            case 'kingmaker2': {
if (!text) return reply(`Example : ${prefix + command} KING BOT MD | CODED BY WHITE HACKERS`)
text1 = text.split("|")[0]
text2 = text.split("|")[1]
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `👋ʜɪ ᴅᴇᴀʀ ${pushname}`,
                    description: `\n\n\n🎭 Input 1ˢᵗ Text -> ${text1}\n🎭 Input 2ⁿᵈ Text -> ${text2}`,
                    buttonText: "ᴛᴀᴘ ʜᴇʀᴇ ᴛᴏ ꜱᴇʟᴇᴄᴛ ʟᴏɢᴏ",
                    footerText: '</> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋɪɴɢ ʙᴏᴛ </>️ ▷',
                    listType: "SINGLE_SELECT",
                    sections: [
...
+'      🔰 ꜰᴏʀ 24/7 ʜᴇʟᴘ ᴍꜱɢ ᴍᴇ 🔰'
                 ...
                 let buttons = [
                     ...
                     { buttonId: 'kingbotinfo', buttonText: {displayText: '🍁 BOT SYSTEM 🍁'}, type: 1}
                ]
                let buttonMessage = {
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ : κιиg οƒƒιϲιαℓ τєαм⚡`
         ...
         let buttons = [
                     { index: 1, urlButton: { displayText: '👨‍💻 GITHUB 👨‍💻', url: 'https://github.com/KING-BOT-OFFICIAL/KING-BOT-MD'}},
                     { index: 2, quickReplyButton: { displayText: 'I COULD\'ND UNDERSTAND'+'\n\n\nYou Can Contact [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] Owner', id: 'bug I could not undestand How to use ehi '}},
...
let buttons = [
            ...
            break
            case 'darkspam': {
            reply('*✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨ְָָָ֭֯֯֯͜͢͡✘ְְַֹֹ֭֭֭֭֮֮֯֯✘ַֻ֢֥֚֫֡֨✘ָ֢֢֯֬֬֡֡✘ְֱָ֢֡֫֡֬֫✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘ְֹ֦֥֡֫֬֫֬✘ְָָֹֺֹ֢֢֢֤֢֦֢֢֢֢֮֡✘ְָ֢֢֭֭֮֬֬✘ְְ֢֢֢֢֭֡✘✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛ͮͮͮͮͮͬ✘ְְְָֺֺ֭֭֭֯✘ְֱֺֺ֢֢֢֢֮֮ͮͮͮͮͮͮ͛͛͛͛͛͛͛͛͛͛͛✘ְַָֺ֣֤֛֛֮֮֯֯֯֯֯֘֘ͯͮͯͮͮͮͮ✘֛֛֮֮֯֯֙ͭͯͯͯͯ✘ְֱֺֺ֢֢֢֢֦֥֚֮֮͛͛͛͛͛͛͛͛͛͛͛֜֘֒✘ֺ֥֛֢֛֭֭֮֮֮֯֯֬֘֜֙✘ְֱֺֺ֢֢֢֢֥֢֛֤֮֮͛͛͛͛͛͛͛͛͛͛͛✘⃚ְ֤֦֣֥֭֭͒֜֯✘ְֱֺֺ֢֢֢֢֮֮͛͛͛͛͛͛͛͛͛͛͛✘֧֦֭֮֮֮͜͢͡🚨͢͡ ͢͜͡𝗞͢͜͡𝗜͢𝗡͢͡𝗚͢͡ ͢͡𝗫͢͡ ͢͜͡𝗕͢͡𝗢͜͢͡𝗧͢͜͡ ͢͡𝗦͜͢͡𝗣͜͢͡𝗔͜͢͡𝗠͜͢͡ ͢͜͡🚨*') }
    break
case 'mainmenu': {
