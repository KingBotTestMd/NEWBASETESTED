...
const kingtime = moment.tz('Asia/Colombo').format('HH:mm:ss')
const kingdate = moment.tz('Asia/Colombo').format('DD/MM/YYYY')
await KingmdWH.setStatus(`🙋‍♂️ 𝐇ᴇʏ 𝐈 ᴀᴍ ❝🪀 🅺︎🅸︎🅽︎🅶︎ 🪀❞ 𝐀ɴ 𝐔ꜱᴇʀ 𝐁ᴏᴛ 𝐅ᴏʀ 𝐖ʜᴀᴛꜱᴀᴘᴘ ▦ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] ▦⌚ ${kingtime}    ▦📅 ${kingdate}    ▦    </> 𝐏ᴏᴡᴇʀᴇᴅ ʙʏ 𝐊𝐈𝐍𝐆 𝐁ᴏᴛ </>️ ▷`) } else {}
...
KingmdWH.sendMessage(from, { react: { text: "⚙️", key: m.key }})
global.grouprules = text.split("|")[0]
king2 = text.split("|")[1]
