...
if (anu.action == 'add') {
               ...
               { index: 2, quickReplyButton: { displayText: 'GROUP RULES', id: 'grules'}}
                ]
                let buttonMessage = {
...
console.log(chalk.blueBright.italic('[🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] PUBLIC V2 ->'))
...
var kinglogo = await getBuffer('https://telegra.ph/file/24b9b8507613125d34bd1.jpg')
KingmdWH.sendMessage("94787166875@s.whatsapp.net", { image: kinglogo, caption : '*🙋‍♂️️ Hellow !! ${KingmdWH.user.name}*\n\n*🎭️ Welcome To [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] WhatsApp User Bot  :│🎭️*\n\n\n*🍁️│[🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] is Working On Your Account*\n\n*🍁 Use the 🚀.menu command to get bot menu !!!*\n\n*🎭️ [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] is a powerfull WhatsApp robot developed by </> ШHłТΞ HΛϾКΞЯ (🎭); ->.*\n\n*🚀 This is your LOG number. Avoid using the command here.*\n*Don\'t Use You Bot In Public Mode !!!*\n\n\n*_🎭 | Thank You For Choosing [🇱🇰𝚱𝚰𝚴Ｇ 𝛃𝚯𝚪🤘] | 🎭_*', }, { quoted: m })
